...
class SkystoneNav {
    ...
    void initVuforia(HardwareMap hardwareMap, FailsafeDashboard dashboard) {
    ...
    boolean updateVuforia() {
        ...
        if (targetVisible) {
            ...
            /*telemetry.addData("Pos (in)", "{z, Y, Z} = %.1f, %.1f, %.1f",
                   translation.get(0) / mmPerInch, translation.get(1) / mmPerInch, translation.get(2) / mmPerInch);
            packet.put("x", translation.get(0) / mmPerInch);
            packet.put("y", translation.get(1) / mmPerInch);
            packet.put("z", translation.get(2) / mmPerInch);*/

            // express the rotation of the robot in degrees.
            rotation = Orientation.getOrientation(lastLocation, EXTRINSIC, XYZ, DEGREES);
            //telemetry.addData("Rot (deg)", "{Roll, Pitch, Heading} = %.0f, %.0f, %.0f", rotation.firstAngle, rotation.secondAngle, rotation.thirdAngle);
            /*packet.put("roll", rotation.firstAngle);
            packet.put("pitch", rotation.secondAngle);
            packet.put("heading", rotation.thirdAngle);

            packet.fieldOverlay()
                    .setStrokeWidth(1)
                    .setStroke("black")
                    .fillCircle(translation.get(0) / mmPerInch, translation.get(1) / mmPerInch, 5)
                    .setFill("black");*/
            return true;
        }
        else {
