...
public class DriiveAutoBlueNoplatform extends LinearOpMode implements TeleAuto {
    ...
    public void runOpMode() {
        ...
        driving.polarAuto(autospeed, 0, 1000 * clicksPerMm, this, 100);
        ...
        driving.stopWheels();
        sleep(100);
        driving.polarAuto(autospeed, PI, 1900 * clicksPerMm, this, 100, true, false);
        switch(position) {
            case 1:
                driving.polarAuto(autospeed, PI, 600, this, 100, false, true);
                break;
            case 2:
                driving.polarAuto(autospeed, PI, 300, this, 100, false, true);
                break;
            case 3:
                break;
        }
        ...
        sleep(100);
        grabBlock();
        driving.polarAuto(autospeed, 0, 1800 * clicksPerMm, this, 100);
        robot.sideliftgrab.setPosition(0);
        /*robot.sidelift.setTargetPosition(robot.sidelift.getTargetPosition() - 1000);
        //driving.polarAuto(0, 0, 0, this);
    ...
    private void grabBlock() {
        ...
        double runtime = getRuntime();
        while(robot.distance_alignment.getDistance(CM) > 5 && getRuntime() < runtime + 1);
        driving.stopWheels();
        sleep(300);
